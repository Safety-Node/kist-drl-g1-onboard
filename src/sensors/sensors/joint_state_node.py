...
2026-05-23 refactor (TASK-999): this node now owns ONLY
...
TODO(REQ-42) [TASK-32]: lowstate subscribe + JointState publish at publish_rate_hz.
"""
import rclpy
...
class JointStateNode(Node):
    def __init__(self) -> None:
        ...
        # TODO(REQ-42) [TASK-32]: declare params (publish_rate_hz, domain_id),
